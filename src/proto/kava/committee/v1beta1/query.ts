...
export const QueryCommitteeRequest = {
  ...
  fromJSON(object: any): QueryCommitteeRequest {
    return {
      committeeId: isSet(object.committeeId) ? Long.fromString(object.committeeId) : Long.UZERO
    };
  },
...
export const QueryNextProposalIDResponse = {
  ...
  fromJSON(object: any): QueryNextProposalIDResponse {
    return {
      nextProposalId: isSet(object.nextProposalId) ? Long.fromString(object.nextProposalId) : Long.UZERO
    };
  },
