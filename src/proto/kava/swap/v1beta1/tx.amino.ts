  ...
  "/kava.swap.v1beta1.MsgDeposit": {
    ...
    toAmino: ({
      ...
      return {
        ...
        token_a: {
          denom: tokenA.denom,
          amount: Long.fromNumber(tokenA.amount).toString()
        },
        token_b: {
          denom: tokenB.denom,
          amount: Long.fromNumber(tokenB.amount).toString()
        },
        slippage,
    ...
    toAmino: ({
      ...
      return {
        ...
        min_token_a: {
          ...
          amount: Long.fromNumber(minTokenA.amount).toString()
        },
        min_token_b: {
          denom: minTokenB.denom,
          amount: Long.fromNumber(minTokenB.amount).toString()
        },
        deadline: deadline.toString()
      };
    },
    ...
    toAmino: ({
      ...
      return {
        ...
        exact_token_a: {
          ...
          amount: Long.fromNumber(exactTokenA.amount).toString()
        },
        token_b: {
          denom: tokenB.denom,
          amount: Long.fromNumber(tokenB.amount).toString()
    ...
    toAmino: ({
      ...
      return {
        ...
        exact_token_b: {
          ...
          amount: Long.fromNumber(exactTokenB.amount).toString()
        },
        slippage,
        deadline: deadline.toString()
      };
