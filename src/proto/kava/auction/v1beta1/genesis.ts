...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      nextAuctionId: isSet(object.nextAuctionId) ? Long.fromString(object.nextAuctionId) : Long.UZERO,
...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    const obj: any = {};
    message.maxAuctionDuration !== undefined && (obj.maxAuctionDuration = message.maxAuctionDuration);
    message.forwardBidDuration !== undefined && (obj.forwardBidDuration = message.forwardBidDuration);
    message.reverseBidDuration !== undefined && (obj.reverseBidDuration = message.reverseBidDuration);
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    const message = createBaseParams();
    message.maxAuctionDuration = object.maxAuctionDuration ?? undefined;
    message.forwardBidDuration = object.forwardBidDuration ?? undefined;
    message.reverseBidDuration = object.reverseBidDuration ?? undefined;
