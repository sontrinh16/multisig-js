...
import { MsgClaimUSDXMintingReward, MsgClaimHardReward, MsgClaimDelegatorReward, MsgClaimSwapReward, MsgClaimSavingsReward } from "./tx";
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/kava.incentive.v1beta1.MsgClaimUSDXMintingReward", MsgClaimUSDXMintingReward], ["/kava.incentive.v1beta1.MsgClaimHardReward", MsgClaimHardReward], ["/kava.incentive.v1beta1.MsgClaimDelegatorReward", MsgClaimDelegatorReward], ["/kava.incentive.v1beta1.MsgClaimSwapReward", MsgClaimSwapReward], ["/kava.incentive.v1beta1.MsgClaimSavingsReward", MsgClaimSavingsReward]];
