...
export const AssetParam = {
  ...
  fromJSON(object: any): AssetParam {
    return {
      ...
      minBlockLock: isSet(object.minBlockLock) ? Long.fromString(object.minBlockLock) : Long.UZERO,
      maxBlockLock: isSet(object.maxBlockLock) ? Long.fromString(object.maxBlockLock) : Long.UZERO
    };
  },
