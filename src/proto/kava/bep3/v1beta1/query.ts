import { SwapStatus, SwapDirection, Params, swapStatusFromJSON, swapDirectionFromJSON, swapStatusToJSON, swapDirectionToJSON } from "./bep3";
...
export const AtomicSwapResponse = {
  ...
  fromJSON(object: any): AtomicSwapResponse {
    return {
      ...
      expireHeight: isSet(object.expireHeight) ? Long.fromString(object.expireHeight) : Long.UZERO,
      timestamp: isSet(object.timestamp) ? Long.fromString(object.timestamp) : Long.ZERO,
      ...
      closedBlock: isSet(object.closedBlock) ? Long.fromString(object.closedBlock) : Long.ZERO,
...
export const QueryAtomicSwapsRequest = {
  ...
  fromJSON(object: any): QueryAtomicSwapsRequest {
    return {
      ...
      expiration: isSet(object.expiration) ? Long.fromString(object.expiration) : Long.UZERO,
      status: isSet(object.status) ? swapStatusFromJSON(object.status) : 0,
      direction: isSet(object.direction) ? swapDirectionFromJSON(object.direction) : 0,
