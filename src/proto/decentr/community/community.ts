...
export const FixedGasParams = {
  ...
  fromJSON(object: any): FixedGasParams {
    return {
      createPost: isSet(object.createPost) ? Long.fromString(object.createPost) : Long.UZERO,
      deletePost: isSet(object.deletePost) ? Long.fromString(object.deletePost) : Long.UZERO,
      setLike: isSet(object.setLike) ? Long.fromString(object.setLike) : Long.UZERO,
      follow: isSet(object.follow) ? Long.fromString(object.follow) : Long.UZERO,
      unfollow: isSet(object.unfollow) ? Long.fromString(object.unfollow) : Long.UZERO
    };
  },

  toJSON(message: FixedGasParams): unknown {
    const obj: any = {};
    message.createPost !== undefined && (obj.createPost = (message.createPost || Long.UZERO).toString());
    message.deletePost !== undefined && (obj.deletePost = (message.deletePost || Long.UZERO).toString());
    message.setLike !== undefined && (obj.setLike = (message.setLike || Long.UZERO).toString());
    message.follow !== undefined && (obj.follow = (message.follow || Long.UZERO).toString());
    message.unfollow !== undefined && (obj.unfollow = (message.unfollow || Long.UZERO).toString());
    return obj;
  },

  fromPartial(object: DeepPartial<FixedGasParams>): FixedGasParams {
    const message = createBaseFixedGasParams();
    message.createPost = object.createPost !== undefined && object.createPost !== null ? Long.fromValue(object.createPost) : Long.UZERO;
    message.deletePost = object.deletePost !== undefined && object.deletePost !== null ? Long.fromValue(object.deletePost) : Long.UZERO;
    message.setLike = object.setLike !== undefined && object.setLike !== null ? Long.fromValue(object.setLike) : Long.UZERO;
    message.follow = object.follow !== undefined && object.follow !== null ? Long.fromValue(object.follow) : Long.UZERO;
    message.unfollow = object.unfollow !== undefined && object.unfollow !== null ? Long.fromValue(object.unfollow) : Long.UZERO;
    return message;
  }
...
export const Post = {
  ...
  fromJSON(object: any): Post {
    return {
      ...
      previewImage: isSet(object.previewImage) ? String(object.previewImage) : "",
  ...
  toJSON(message: Post): unknown {
    ...
    message.previewImage !== undefined && (obj.previewImage = message.previewImage);
...
export const Like = {
  ...
  toJSON(message: Like): unknown {
    ...
    message.weight !== undefined && (obj.weight = likeWeightToJSON(message.weight));
    return obj;
  },
