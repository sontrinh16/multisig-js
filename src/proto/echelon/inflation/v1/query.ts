...
export const QueryTotalSupplyResponse = {
  ...
  fromJSON(object: any): QueryTotalSupplyResponse {
    return {
      totalSupply: isSet(object.totalSupply) ? DecCoin.fromJSON(object.totalSupply) : undefined
    };
  },

  toJSON(message: QueryTotalSupplyResponse): unknown {
    const obj: any = {};
    message.totalSupply !== undefined && (obj.totalSupply = message.totalSupply ? DecCoin.toJSON(message.totalSupply) : undefined);
    return obj;
  },

  fromPartial(object: DeepPartial<QueryTotalSupplyResponse>): QueryTotalSupplyResponse {
    const message = createBaseQueryTotalSupplyResponse();
    message.totalSupply = object.totalSupply !== undefined && object.totalSupply !== null ? DecCoin.fromPartial(object.totalSupply) : undefined;
    return message;
  }
