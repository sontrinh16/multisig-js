...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/echelon.erc20.v1.MsgConvertCoin", MsgConvertCoin], ["/echelon.erc20.v1.MsgConvertERC20", MsgConvertERC20]];
...
export const MessageComposer = {
  encoded: {
    convertCoin(value: MsgConvertCoin) {
      return {
        typeUrl: "/echelon.erc20.v1.MsgConvertCoin",
    ...
    convertERC20(value: MsgConvertERC20) {
      return {
        typeUrl: "/echelon.erc20.v1.MsgConvertERC20",
