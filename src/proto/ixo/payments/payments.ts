...
export const BlockPeriod = {
  ...
  fromJSON(object: any): BlockPeriod {
    return {
      periodLength: isSet(object.periodLength) ? Long.fromString(object.periodLength) : Long.ZERO,
      periodStartBlock: isSet(object.periodStartBlock) ? Long.fromString(object.periodStartBlock) : Long.ZERO
    };
  },
