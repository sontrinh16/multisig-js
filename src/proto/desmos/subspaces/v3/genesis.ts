...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      initialSubspaceId: isSet(object.initialSubspaceId) ? Long.fromString(object.initialSubspaceId) : Long.UZERO,
      subspacesData: Array.isArray(object?.subspacesData) ? object.subspacesData.map((e: any) => SubspaceData.fromJSON(e)) : [],
      ...
      userPermissions: Array.isArray(object?.userPermissions) ? object.userPermissions.map((e: any) => UserPermission.fromJSON(e)) : [],
      userGroups: Array.isArray(object?.userGroups) ? object.userGroups.map((e: any) => UserGroup.fromJSON(e)) : [],
      userGroupsMembers: Array.isArray(object?.userGroupsMembers) ? object.userGroupsMembers.map((e: any) => UserGroupMemberEntry.fromJSON(e)) : []
    };
  },

  toJSON(message: GenesisState): unknown {
    const obj: any = {};
    message.initialSubspaceId !== undefined && (obj.initialSubspaceId = (message.initialSubspaceId || Long.UZERO).toString());
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    const message = createBaseGenesisState();
    message.initialSubspaceId = object.initialSubspaceId !== undefined && object.initialSubspaceId !== null ? Long.fromValue(object.initialSubspaceId) : Long.UZERO;
