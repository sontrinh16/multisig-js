...
export const QueryApplicationLinkByClientIDResponse = {
  ...
  fromJSON(object: any): QueryApplicationLinkByClientIDResponse {
    return {
      link: isSet(object.link) ? ApplicationLink.fromJSON(object.link) : undefined
    };
  },
  ...
  fromPartial(object: DeepPartial<QueryApplicationLinkByClientIDResponse>): QueryApplicationLinkByClientIDResponse {
    const message = createBaseQueryApplicationLinkByClientIDResponse();
    message.link = object.link !== undefined && object.link !== null ? ApplicationLink.fromPartial(object.link) : undefined;
    return message;
  }
...
export const QueryApplicationLinkOwnersResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryApplicationLinkOwnersResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.owners.push(QueryApplicationLinkOwnersResponse_ApplicationLinkOwnerDetails.decode(reader, reader.uint32()));
          break;
  ...
  fromJSON(object: any): QueryApplicationLinkOwnersResponse {
    return {
      owners: Array.isArray(object?.owners) ? object.owners.map((e: any) => QueryApplicationLinkOwnersResponse_ApplicationLinkOwnerDetails.fromJSON(e)) : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined
    };
  },
  ...
  toJSON(message: QueryApplicationLinkOwnersResponse): unknown {
    ...
    if (message.owners) {
      obj.owners = message.owners.map(e => e ? QueryApplicationLinkOwnersResponse_ApplicationLinkOwnerDetails.toJSON(e) : undefined);
    } else {
      obj.owners = [];
    }
  ...
  fromPartial(object: DeepPartial<QueryApplicationLinkOwnersResponse>): QueryApplicationLinkOwnersResponse {
    const message = createBaseQueryApplicationLinkOwnersResponse();
    message.owners = object.owners?.map(e => QueryApplicationLinkOwnersResponse_ApplicationLinkOwnerDetails.fromPartial(e)) || [];
    message.pagination = object.pagination !== undefined && object.pagination !== null ? PageResponse.fromPartial(object.pagination) : undefined;
    return message;
  }
...
export const QueryApplicationLinkOwnersResponse_ApplicationLinkOwnerDetails = {
  encode(message: QueryApplicationLinkOwnersResponse_ApplicationLinkOwnerDetails, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.user !== "") {
      writer.uint32(10).string(message.user);
    }
