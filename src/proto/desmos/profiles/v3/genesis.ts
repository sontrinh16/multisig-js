...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      dtagTransferRequests: Array.isArray(object?.dtagTransferRequests) ? object.dtagTransferRequests.map((e: any) => DTagTransferRequest.fromJSON(e)) : [],
      chainLinks: Array.isArray(object?.chainLinks) ? object.chainLinks.map((e: any) => ChainLink.fromJSON(e)) : [],
      applicationLinks: Array.isArray(object?.applicationLinks) ? object.applicationLinks.map((e: any) => ApplicationLink.fromJSON(e)) : [],
      defaultExternalAddresses: Array.isArray(object?.defaultExternalAddresses) ? object.defaultExternalAddresses.map((e: any) => DefaultExternalAddressEntry.fromJSON(e)) : [],
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.defaultExternalAddresses) {
      obj.defaultExternalAddresses = message.defaultExternalAddresses.map(e => e ? DefaultExternalAddressEntry.toJSON(e) : undefined);
    } else {
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    message.defaultExternalAddresses = object.defaultExternalAddresses?.map(e => DefaultExternalAddressEntry.fromPartial(e)) || [];
