...
export const QueryChainLinkOwnersResponse = {
  ...
  fromJSON(object: any): QueryChainLinkOwnersResponse {
    return {
      owners: Array.isArray(object?.owners) ? object.owners.map((e: any) => QueryChainLinkOwnersResponse_ChainLinkOwnerDetails.fromJSON(e)) : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined
    };
  },
  ...
  toJSON(message: QueryChainLinkOwnersResponse): unknown {
    ...
    if (message.owners) {
      obj.owners = message.owners.map(e => e ? QueryChainLinkOwnersResponse_ChainLinkOwnerDetails.toJSON(e) : undefined);
    } else {
      obj.owners = [];
    }
...
export const QueryChainLinkOwnersResponse_ChainLinkOwnerDetails = {
  encode(message: QueryChainLinkOwnersResponse_ChainLinkOwnerDetails, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.user !== "") {
      writer.uint32(10).string(message.user);
    }
