...
export const LinkChainAccountPacketData = {
  ...
  toJSON(message: LinkChainAccountPacketData): unknown {
    const obj: any = {};
    message.sourceAddress !== undefined && (obj.sourceAddress = message.sourceAddress ? Any.toJSON(message.sourceAddress) : undefined);
    message.sourceProof !== undefined && (obj.sourceProof = message.sourceProof ? Proof.toJSON(message.sourceProof) : undefined);
    message.sourceChainConfig !== undefined && (obj.sourceChainConfig = message.sourceChainConfig ? ChainConfig.toJSON(message.sourceChainConfig) : undefined);
    message.destinationAddress !== undefined && (obj.destinationAddress = message.destinationAddress);
    message.destinationProof !== undefined && (obj.destinationProof = message.destinationProof ? Proof.toJSON(message.destinationProof) : undefined);
    return obj;
  },

  fromPartial(object: DeepPartial<LinkChainAccountPacketData>): LinkChainAccountPacketData {
    const message = createBaseLinkChainAccountPacketData();
    message.sourceAddress = object.sourceAddress !== undefined && object.sourceAddress !== null ? Any.fromPartial(object.sourceAddress) : undefined;
    message.sourceProof = object.sourceProof !== undefined && object.sourceProof !== null ? Proof.fromPartial(object.sourceProof) : undefined;
    message.sourceChainConfig = object.sourceChainConfig !== undefined && object.sourceChainConfig !== null ? ChainConfig.fromPartial(object.sourceChainConfig) : undefined;
    message.destinationAddress = object.destinationAddress ?? "";
    message.destinationProof = object.destinationProof !== undefined && object.destinationProof !== null ? Proof.fromPartial(object.destinationProof) : undefined;
    return message;
  }
