...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      subspacesData: Array.isArray(object?.subspacesData) ? object.subspacesData.map((e: any) => SubspaceDataEntry.fromJSON(e)) : [],
      ...
      activePolls: Array.isArray(object?.activePolls) ? object.activePolls.map((e: any) => ActivePollData.fromJSON(e)) : [],
...
export const SubspaceDataEntry = {
  ...
  fromJSON(object: any): SubspaceDataEntry {
    return {
      ...
      initialPostId: isSet(object.initialPostId) ? Long.fromString(object.initialPostId) : Long.UZERO
    };
  },
  ...
  fromPartial(object: DeepPartial<SubspaceDataEntry>): SubspaceDataEntry {
    ...
    message.initialPostId = object.initialPostId !== undefined && object.initialPostId !== null ? Long.fromValue(object.initialPostId) : Long.UZERO;
    return message;
  }
