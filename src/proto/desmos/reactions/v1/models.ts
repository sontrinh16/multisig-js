...
export const SubspaceReactionsParams = {
  ...
  fromJSON(object: any): SubspaceReactionsParams {
    return {
      subspaceId: isSet(object.subspaceId) ? Long.fromString(object.subspaceId) : Long.UZERO,
      registeredReaction: isSet(object.registeredReaction) ? RegisteredReactionValueParams.fromJSON(object.registeredReaction) : undefined,
  ...
  toJSON(message: SubspaceReactionsParams): unknown {
    const obj: any = {};
    message.subspaceId !== undefined && (obj.subspaceId = (message.subspaceId || Long.UZERO).toString());
    message.registeredReaction !== undefined && (obj.registeredReaction = message.registeredReaction ? RegisteredReactionValueParams.toJSON(message.registeredReaction) : undefined);
    message.freeText !== undefined && (obj.freeText = message.freeText ? FreeTextValueParams.toJSON(message.freeText) : undefined);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<SubspaceReactionsParams>): SubspaceReactionsParams {
    const message = createBaseSubspaceReactionsParams();
    message.subspaceId = object.subspaceId !== undefined && object.subspaceId !== null ? Long.fromValue(object.subspaceId) : Long.UZERO;
    message.registeredReaction = object.registeredReaction !== undefined && object.registeredReaction !== null ? RegisteredReactionValueParams.fromPartial(object.registeredReaction) : undefined;
    message.freeText = object.freeText !== undefined && object.freeText !== null ? FreeTextValueParams.fromPartial(object.freeText) : undefined;
    return message;
  }
