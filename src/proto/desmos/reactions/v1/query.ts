...
export const QueryRegisteredReactionsResponse = {
  ...
  fromJSON(object: any): QueryRegisteredReactionsResponse {
    return {
      registeredReactions: Array.isArray(object?.registeredReactions) ? object.registeredReactions.map((e: any) => RegisteredReaction.fromJSON(e)) : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined
    };
  },
...
export const QueryRegisteredReactionResponse = {
  ...
  fromJSON(object: any): QueryRegisteredReactionResponse {
    return {
      registeredReaction: isSet(object.registeredReaction) ? RegisteredReaction.fromJSON(object.registeredReaction) : undefined
    };
  },

  toJSON(message: QueryRegisteredReactionResponse): unknown {
    const obj: any = {};
    message.registeredReaction !== undefined && (obj.registeredReaction = message.registeredReaction ? RegisteredReaction.toJSON(message.registeredReaction) : undefined);
    return obj;
  },

  fromPartial(object: DeepPartial<QueryRegisteredReactionResponse>): QueryRegisteredReactionResponse {
    const message = createBaseQueryRegisteredReactionResponse();
    message.registeredReaction = object.registeredReaction !== undefined && object.registeredReaction !== null ? RegisteredReaction.fromPartial(object.registeredReaction) : undefined;
    return message;
  }
...
export const QueryReactionsParamsResponse = {
  ...
  fromJSON(object: any): QueryReactionsParamsResponse {
    return {
      params: isSet(object.params) ? SubspaceReactionsParams.fromJSON(object.params) : undefined
    };
  },

  toJSON(message: QueryReactionsParamsResponse): unknown {
    const obj: any = {};
    message.params !== undefined && (obj.params = message.params ? SubspaceReactionsParams.toJSON(message.params) : undefined);
    return obj;
  },

  fromPartial(object: DeepPartial<QueryReactionsParamsResponse>): QueryReactionsParamsResponse {
    const message = createBaseQueryReactionsParamsResponse();
    message.params = object.params !== undefined && object.params !== null ? SubspaceReactionsParams.fromPartial(object.params) : undefined;
    return message;
  }
