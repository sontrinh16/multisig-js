...
export const SetReactionsParamsJSON = {
  ...
  fromJSON(object: any): SetReactionsParamsJSON {
    return {
      registeredReactionParams: isSet(object.registeredReactionParams) ? RegisteredReactionValueParams.fromJSON(object.registeredReactionParams) : undefined,
  ...
  toJSON(message: SetReactionsParamsJSON): unknown {
    const obj: any = {};
    message.registeredReactionParams !== undefined && (obj.registeredReactionParams = message.registeredReactionParams ? RegisteredReactionValueParams.toJSON(message.registeredReactionParams) : undefined);
    message.freeTextParams !== undefined && (obj.freeTextParams = message.freeTextParams ? FreeTextValueParams.toJSON(message.freeTextParams) : undefined);
    return obj;
  },

  fromPartial(object: DeepPartial<SetReactionsParamsJSON>): SetReactionsParamsJSON {
    const message = createBaseSetReactionsParamsJSON();
    message.registeredReactionParams = object.registeredReactionParams !== undefined && object.registeredReactionParams !== null ? RegisteredReactionValueParams.fromPartial(object.registeredReactionParams) : undefined;
    message.freeTextParams = object.freeTextParams !== undefined && object.freeTextParams !== null ? FreeTextValueParams.fromPartial(object.freeTextParams) : undefined;
    return message;
  }
