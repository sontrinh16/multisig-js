...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      recoveryPeriod: isSet(object.recoveryPeriod) ? Long.fromString(object.recoveryPeriod) : Long.UZERO,
      adjustPricePeriod: isSet(object.adjustPricePeriod) ? Long.fromString(object.adjustPricePeriod) : Long.UZERO,
      basePrice: isSet(object.basePrice) ? String(object.basePrice) : "",
      baseLoad: isSet(object.baseLoad) ? String(object.baseLoad) : "",
      maxBlockBandwidth: isSet(object.maxBlockBandwidth) ? Long.fromString(object.maxBlockBandwidth) : Long.UZERO
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.adjustPricePeriod !== undefined && (obj.adjustPricePeriod = (message.adjustPricePeriod || Long.UZERO).toString());
    message.basePrice !== undefined && (obj.basePrice = message.basePrice);
    message.baseLoad !== undefined && (obj.baseLoad = message.baseLoad);
    message.maxBlockBandwidth !== undefined && (obj.maxBlockBandwidth = (message.maxBlockBandwidth || Long.UZERO).toString());
    return obj;
  },

  fromPartial(object: DeepPartial<Params>): Params {
    const message = createBaseParams();
    message.recoveryPeriod = object.recoveryPeriod !== undefined && object.recoveryPeriod !== null ? Long.fromValue(object.recoveryPeriod) : Long.UZERO;
    message.adjustPricePeriod = object.adjustPricePeriod !== undefined && object.adjustPricePeriod !== null ? Long.fromValue(object.adjustPricePeriod) : Long.UZERO;
    message.basePrice = object.basePrice ?? "";
    message.baseLoad = object.baseLoad ?? "";
    message.maxBlockBandwidth = object.maxBlockBandwidth !== undefined && object.maxBlockBandwidth !== null ? Long.fromValue(object.maxBlockBandwidth) : Long.UZERO;
    return message;
  }
...
export const NeuronBandwidth = {
  ...
  fromJSON(object: any): NeuronBandwidth {
    return {
      ...
      remainedValue: isSet(object.remainedValue) ? Long.fromString(object.remainedValue) : Long.UZERO,
      lastUpdatedBlock: isSet(object.lastUpdatedBlock) ? Long.fromString(object.lastUpdatedBlock) : Long.UZERO,
      maxValue: isSet(object.maxValue) ? Long.fromString(object.maxValue) : Long.UZERO
    };
  },
  ...
  toJSON(message: NeuronBandwidth): unknown {
    ...
    message.lastUpdatedBlock !== undefined && (obj.lastUpdatedBlock = (message.lastUpdatedBlock || Long.UZERO).toString());
  ...
  fromPartial(object: DeepPartial<NeuronBandwidth>): NeuronBandwidth {
    ...
    message.remainedValue = object.remainedValue !== undefined && object.remainedValue !== null ? Long.fromValue(object.remainedValue) : Long.UZERO;
    message.lastUpdatedBlock = object.lastUpdatedBlock !== undefined && object.lastUpdatedBlock !== null ? Long.fromValue(object.lastUpdatedBlock) : Long.UZERO;
