...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      ...
      signedLogicCallsWindow: isSet(object.signedLogicCallsWindow) ? Long.fromString(object.signedLogicCallsWindow) : Long.UZERO,
      ...
      averageEthereumBlockTime: isSet(object.averageEthereumBlockTime) ? Long.fromString(object.averageEthereumBlockTime) : Long.UZERO,
      ...
      unbondSlashingValsetsWindow: isSet(object.unbondSlashingValsetsWindow) ? Long.fromString(object.unbondSlashingValsetsWindow) : Long.UZERO,
...
export const GravityNonces = {
  ...
  fromJSON(object: any): GravityNonces {
    return {
      ...
      lastSlashedValsetNonce: isSet(object.lastSlashedValsetNonce) ? Long.fromString(object.lastSlashedValsetNonce) : Long.UZERO,
      lastSlashedBatchBlock: isSet(object.lastSlashedBatchBlock) ? Long.fromString(object.lastSlashedBatchBlock) : Long.UZERO,
      lastSlashedLogicCallBlock: isSet(object.lastSlashedLogicCallBlock) ? Long.fromString(object.lastSlashedLogicCallBlock) : Long.UZERO,
