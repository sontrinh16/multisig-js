...
export const ClassInfo = {
  ...
  fromJSON(object: any): ClassInfo {
    return {
      ...
      numBatches: isSet(object.numBatches) ? Long.fromString(object.numBatches) : Long.UZERO
    };
  },
...
export const CreditTypeSeq = {
  ...
  fromJSON(object: any): CreditTypeSeq {
    return {
      abbreviation: isSet(object.abbreviation) ? String(object.abbreviation) : "",
      seqNumber: isSet(object.seqNumber) ? Long.fromString(object.seqNumber) : Long.UZERO
    };
  },
