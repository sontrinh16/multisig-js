...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      ...
      keygenGracePeriod: isSet(object.keygenGracePeriod) ? Long.fromString(object.keygenGracePeriod) : Long.ZERO,
      signingTimeout: isSet(object.signingTimeout) ? Long.fromString(object.signingTimeout) : Long.ZERO,
      signingGracePeriod: isSet(object.signingGracePeriod) ? Long.fromString(object.signingGracePeriod) : Long.ZERO,
      activeEpochCount: isSet(object.activeEpochCount) ? Long.fromString(object.activeEpochCount) : Long.UZERO
    };
  },

  toJSON(message: Params): unknown {
    const obj: any = {};
    message.keygenThreshold !== undefined && (obj.keygenThreshold = message.keygenThreshold ? Threshold.toJSON(message.keygenThreshold) : undefined);
    message.signingThreshold !== undefined && (obj.signingThreshold = message.signingThreshold ? Threshold.toJSON(message.signingThreshold) : undefined);
    message.keygenTimeout !== undefined && (obj.keygenTimeout = (message.keygenTimeout || Long.ZERO).toString());
    message.keygenGracePeriod !== undefined && (obj.keygenGracePeriod = (message.keygenGracePeriod || Long.ZERO).toString());
    message.signingTimeout !== undefined && (obj.signingTimeout = (message.signingTimeout || Long.ZERO).toString());
    message.signingGracePeriod !== undefined && (obj.signingGracePeriod = (message.signingGracePeriod || Long.ZERO).toString());
    message.activeEpochCount !== undefined && (obj.activeEpochCount = (message.activeEpochCount || Long.UZERO).toString());
    return obj;
  },
