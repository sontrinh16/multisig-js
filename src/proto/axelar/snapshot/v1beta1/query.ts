...
export const QueryValidatorsResponse_Validator = {
  ...
  toJSON(message: QueryValidatorsResponse_Validator): unknown {
    ...
    message.tssIllegibilityInfo !== undefined && (obj.tssIllegibilityInfo = message.tssIllegibilityInfo ? QueryValidatorsResponse_TssIllegibilityInfo.toJSON(message.tssIllegibilityInfo) : undefined);
    return obj;
  },
