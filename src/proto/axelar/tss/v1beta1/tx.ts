...
import { KeyRole, SigKeyPair, keyRoleFromJSON, keyRoleToJSON } from "../exported/v1beta1/types";
...
export const StartKeygenRequest = {
  ...
  toJSON(message: StartKeygenRequest): unknown {
    ...
    message.keyInfo !== undefined && (obj.keyInfo = message.keyInfo ? KeyInfo.toJSON(message.keyInfo) : undefined);
    return obj;
  },
...
export const ProcessKeygenTrafficRequest = {
  ...
  toJSON(message: ProcessKeygenTrafficRequest): unknown {
    ...
    message.payload !== undefined && (obj.payload = message.payload ? TrafficOut.toJSON(message.payload) : undefined);
    return obj;
  },
...
export const VotePubKeyRequest = {
  ...
  toJSON(message: VotePubKeyRequest): unknown {
    const obj: any = {};
    message.sender !== undefined && (obj.sender = base64FromBytes(message.sender !== undefined ? message.sender : new Uint8Array()));
    message.pollKey !== undefined && (obj.pollKey = message.pollKey ? PollKey.toJSON(message.pollKey) : undefined);
    message.result !== undefined && (obj.result = message.result ? MessageOut_KeygenResult.toJSON(message.result) : undefined);
    return obj;
  },
...
export const VoteSigRequest = {
  ...
  toJSON(message: VoteSigRequest): unknown {
    ...
    message.sender !== undefined && (obj.sender = base64FromBytes(message.sender !== undefined ? message.sender : new Uint8Array()));
    message.pollKey !== undefined && (obj.pollKey = message.pollKey ? PollKey.toJSON(message.pollKey) : undefined);
    message.result !== undefined && (obj.result = message.result ? MessageOut_SignResult.toJSON(message.result) : undefined);
    return obj;
  },
...
export const RegisterExternalKeysRequest = {
  ...
  toJSON(message: RegisterExternalKeysRequest): unknown {
    ...
    if (message.externalKeys) {
      obj.externalKeys = message.externalKeys.map(e => e ? RegisterExternalKeysRequest_ExternalKey.toJSON(e) : undefined);
    } else {
      obj.externalKeys = [];
    }
