import { KeyRole, KeyType, keyRoleFromJSON, keyTypeFromJSON, keyRoleToJSON, keyTypeToJSON } from "../exported/v1beta1/types";
...
export const KeygenVoteData = {
  ...
  toJSON(message: KeygenVoteData): unknown {
    ...
    message.groupRecoveryInfo !== undefined && (obj.groupRecoveryInfo = base64FromBytes(message.groupRecoveryInfo !== undefined ? message.groupRecoveryInfo : new Uint8Array()));
    return obj;
  },
...
export const MultisigInfo = {
  ...
  fromJSON(object: any): MultisigInfo {
    return {
      ...
      timeout: isSet(object.timeout) ? Long.fromString(object.timeout) : Long.ZERO,
      targetNum: isSet(object.targetNum) ? Long.fromString(object.targetNum) : Long.ZERO,
...
export const KeyRecoveryInfo = {
  ...
  toJSON(message: KeyRecoveryInfo): unknown {
    const obj: any = {};
    message.keyId !== undefined && (obj.keyId = message.keyId);
    message.public !== undefined && (obj.public = base64FromBytes(message.public !== undefined ? message.public : new Uint8Array()));
    obj.private = {};

    if (message.private) {
      Object.entries(message.private).forEach(([k, v]) => {
        obj.private[k] = bytes.toJSON(v);
      });
    }
...
export const ValidatorStatus = {
  ...
  fromJSON(object: any): ValidatorStatus {
    return {
      ...
      suspendedUntil: isSet(object.suspendedUntil) ? Long.fromString(object.suspendedUntil) : Long.UZERO
    };
  },
