...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      ...
      suspendDurationInBlocks: isSet(object.suspendDurationInBlocks) ? Long.fromString(object.suspendDurationInBlocks) : Long.ZERO,
      heartbeatPeriodInBlocks: isSet(object.heartbeatPeriodInBlocks) ? Long.fromString(object.heartbeatPeriodInBlocks) : Long.ZERO,
      ...
      unbondingLockingKeyRotationCount: isSet(object.unbondingLockingKeyRotationCount) ? Long.fromString(object.unbondingLockingKeyRotationCount) : Long.ZERO,
      ...
      maxSignQueueSize: isSet(object.maxSignQueueSize) ? Long.fromString(object.maxSignQueueSize) : Long.ZERO,
      maxSimultaneousSignShares: isSet(object.maxSimultaneousSignShares) ? Long.fromString(object.maxSimultaneousSignShares) : Long.ZERO,
      tssSignedBlocksWindow: isSet(object.tssSignedBlocksWindow) ? Long.fromString(object.tssSignedBlocksWindow) : Long.ZERO
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.suspendDurationInBlocks !== undefined && (obj.suspendDurationInBlocks = (message.suspendDurationInBlocks || Long.ZERO).toString());
    message.heartbeatPeriodInBlocks !== undefined && (obj.heartbeatPeriodInBlocks = (message.heartbeatPeriodInBlocks || Long.ZERO).toString());
    message.maxMissedBlocksPerWindow !== undefined && (obj.maxMissedBlocksPerWindow = message.maxMissedBlocksPerWindow ? Threshold.toJSON(message.maxMissedBlocksPerWindow) : undefined);
    message.unbondingLockingKeyRotationCount !== undefined && (obj.unbondingLockingKeyRotationCount = (message.unbondingLockingKeyRotationCount || Long.ZERO).toString());
    message.externalMultisigThreshold !== undefined && (obj.externalMultisigThreshold = message.externalMultisigThreshold ? Threshold.toJSON(message.externalMultisigThreshold) : undefined);
    message.maxSignQueueSize !== undefined && (obj.maxSignQueueSize = (message.maxSignQueueSize || Long.ZERO).toString());
    message.maxSimultaneousSignShares !== undefined && (obj.maxSimultaneousSignShares = (message.maxSimultaneousSignShares || Long.ZERO).toString());
    message.tssSignedBlocksWindow !== undefined && (obj.tssSignedBlocksWindow = (message.tssSignedBlocksWindow || Long.ZERO).toString());
    return obj;
  },
