...
export const RecoverRequest = {
  ...
  toJSON(message: RecoverRequest): unknown {
    const obj: any = {};
    message.keygenInit !== undefined && (obj.keygenInit = message.keygenInit ? KeygenInit.toJSON(message.keygenInit) : undefined);
    message.keygenOutput !== undefined && (obj.keygenOutput = message.keygenOutput ? KeygenOutput.toJSON(message.keygenOutput) : undefined);
    return obj;
  },
...
export const KeygenOutput = {
  ...
  toJSON(message: KeygenOutput): unknown {
    ...
    message.groupRecoverInfo !== undefined && (obj.groupRecoverInfo = base64FromBytes(message.groupRecoverInfo !== undefined ? message.groupRecoverInfo : new Uint8Array()));
    message.privateRecoverInfo !== undefined && (obj.privateRecoverInfo = base64FromBytes(message.privateRecoverInfo !== undefined ? message.privateRecoverInfo : new Uint8Array()));
    return obj;
  },
...
export const MessageOut = {
  ...
  toJSON(message: MessageOut): unknown {
    ...
    message.keygenResult !== undefined && (obj.keygenResult = message.keygenResult ? MessageOut_KeygenResult.toJSON(message.keygenResult) : undefined);
    message.signResult !== undefined && (obj.signResult = message.signResult ? MessageOut_SignResult.toJSON(message.signResult) : undefined);
...
export const MessageOut_KeygenResult = {
  ...
  toJSON(message: MessageOut_KeygenResult): unknown {
    ...
    message.criminals !== undefined && (obj.criminals = message.criminals ? MessageOut_CriminalList.toJSON(message.criminals) : undefined);
    return obj;
  },
...
export const MessageOut_CriminalList_Criminal = {
  ...
  toJSON(message: MessageOut_CriminalList_Criminal): unknown {
    ...
    message.crimeType !== undefined && (obj.crimeType = messageOut_CriminalList_Criminal_CrimeTypeToJSON(message.crimeType));
    return obj;
  },
...
export const SignInit = {
  ...
  toJSON(message: SignInit): unknown {
    ...
    message.messageToSign !== undefined && (obj.messageToSign = base64FromBytes(message.messageToSign !== undefined ? message.messageToSign : new Uint8Array()));
    return obj;
  },
