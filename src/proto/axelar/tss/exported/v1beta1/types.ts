...
export const KeyRequirement = {
  ...
  fromJSON(object: any): KeyRequirement {
    return {
      ...
      maxTotalShareCount: isSet(object.maxTotalShareCount) ? Long.fromString(object.maxTotalShareCount) : Long.ZERO,
      minTotalShareCount: isSet(object.minTotalShareCount) ? Long.fromString(object.minTotalShareCount) : Long.ZERO,
      ...
      keygenTimeout: isSet(object.keygenTimeout) ? Long.fromString(object.keygenTimeout) : Long.ZERO,
      signTimeout: isSet(object.signTimeout) ? Long.fromString(object.signTimeout) : Long.ZERO
    };
  },
  ...
  toJSON(message: KeyRequirement): unknown {
    ...
    message.minKeygenThreshold !== undefined && (obj.minKeygenThreshold = message.minKeygenThreshold ? Threshold.toJSON(message.minKeygenThreshold) : undefined);
    message.safetyThreshold !== undefined && (obj.safetyThreshold = message.safetyThreshold ? Threshold.toJSON(message.safetyThreshold) : undefined);
    message.keyShareDistributionPolicy !== undefined && (obj.keyShareDistributionPolicy = keyShareDistributionPolicyToJSON(message.keyShareDistributionPolicy));
    message.maxTotalShareCount !== undefined && (obj.maxTotalShareCount = (message.maxTotalShareCount || Long.ZERO).toString());
    message.minTotalShareCount !== undefined && (obj.minTotalShareCount = (message.minTotalShareCount || Long.ZERO).toString());
    message.keygenVotingThreshold !== undefined && (obj.keygenVotingThreshold = message.keygenVotingThreshold ? Threshold.toJSON(message.keygenVotingThreshold) : undefined);
    message.signVotingThreshold !== undefined && (obj.signVotingThreshold = message.signVotingThreshold ? Threshold.toJSON(message.signVotingThreshold) : undefined);
    message.keygenTimeout !== undefined && (obj.keygenTimeout = (message.keygenTimeout || Long.ZERO).toString());
