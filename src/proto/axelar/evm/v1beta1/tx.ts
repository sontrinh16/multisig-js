...
export const SignCommandsResponse = {
  ...
  toJSON(message: SignCommandsResponse): unknown {
    const obj: any = {};
    message.batchedCommandsId !== undefined && (obj.batchedCommandsId = base64FromBytes(message.batchedCommandsId !== undefined ? message.batchedCommandsId : new Uint8Array()));
