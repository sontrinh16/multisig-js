...
export const Event = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Event {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          message.multisigOwnershipTransferred = EventMultisigOwnershipTransferred.decode(reader, reader.uint32());
          break;

        case 11:
          message.multisigOperatorshipTransferred = EventMultisigOperatorshipTransferred.decode(reader, reader.uint32());
          break;
  ...
  toJSON(message: Event): unknown {
    ...
    message.tokenSent !== undefined && (obj.tokenSent = message.tokenSent ? EventTokenSent.toJSON(message.tokenSent) : undefined);
    message.contractCall !== undefined && (obj.contractCall = message.contractCall ? EventContractCall.toJSON(message.contractCall) : undefined);
    message.contractCallWithToken !== undefined && (obj.contractCallWithToken = message.contractCallWithToken ? EventContractCallWithToken.toJSON(message.contractCallWithToken) : undefined);
    message.transfer !== undefined && (obj.transfer = message.transfer ? EventTransfer.toJSON(message.transfer) : undefined);
    message.tokenDeployed !== undefined && (obj.tokenDeployed = message.tokenDeployed ? EventTokenDeployed.toJSON(message.tokenDeployed) : undefined);
    message.multisigOwnershipTransferred !== undefined && (obj.multisigOwnershipTransferred = message.multisigOwnershipTransferred ? EventMultisigOwnershipTransferred.toJSON(message.multisigOwnershipTransferred) : undefined);
    message.multisigOperatorshipTransferred !== undefined && (obj.multisigOperatorshipTransferred = message.multisigOperatorshipTransferred ? EventMultisigOperatorshipTransferred.toJSON(message.multisigOperatorshipTransferred) : undefined);
    return obj;
  },
...
export const EventMultisigOwnershipTransferred = {
  ...
  toJSON(message: EventMultisigOwnershipTransferred): unknown {
    ...
    message.prevThreshold !== undefined && (obj.prevThreshold = base64FromBytes(message.prevThreshold !== undefined ? message.prevThreshold : new Uint8Array()));
    ...
    message.newThreshold !== undefined && (obj.newThreshold = base64FromBytes(message.newThreshold !== undefined ? message.newThreshold : new Uint8Array()));
    return obj;
  },
...
export const ERC20TokenMetadata = {
  ...
  toJSON(message: ERC20TokenMetadata): unknown {
    const obj: any = {};
    message.asset !== undefined && (obj.asset = message.asset);
    message.chainId !== undefined && (obj.chainId = base64FromBytes(message.chainId !== undefined ? message.chainId : new Uint8Array()));
    ...
    message.burnerCode !== undefined && (obj.burnerCode = base64FromBytes(message.burnerCode !== undefined ? message.burnerCode : new Uint8Array()));
    return obj;
  },
...
export const TransactionMetadata = {
  ...
  toJSON(message: TransactionMetadata): unknown {
    const obj: any = {};
    message.rawTx !== undefined && (obj.rawTx = base64FromBytes(message.rawTx !== undefined ? message.rawTx : new Uint8Array()));
...
export const Command = {
  ...
  toJSON(message: Command): unknown {
    ...
    message.params !== undefined && (obj.params = base64FromBytes(message.params !== undefined ? message.params : new Uint8Array()));
...
export const CommandBatchMetadata = {
  ...
  toJSON(message: CommandBatchMetadata): unknown {
    ...
    message.sigHash !== undefined && (obj.sigHash = base64FromBytes(message.sigHash !== undefined ? message.sigHash : new Uint8Array()));
    message.status !== undefined && (obj.status = batchedCommandsStatusToJSON(message.status));
    message.keyId !== undefined && (obj.keyId = message.keyId);
    message.prevBatchedCommandsId !== undefined && (obj.prevBatchedCommandsId = base64FromBytes(message.prevBatchedCommandsId !== undefined ? message.prevBatchedCommandsId : new Uint8Array()));
...
export const TokenDetails = {
  ...
  toJSON(message: TokenDetails): unknown {
    ...
    message.capacity !== undefined && (obj.capacity = base64FromBytes(message.capacity !== undefined ? message.capacity : new Uint8Array()));
    return obj;
  },
