...
export const GenesisState_Chain = {
  ...
  toJSON(message: GenesisState_Chain): unknown {
    ...
    message.commandQueue !== undefined && (obj.commandQueue = message.commandQueue ? QueueState.toJSON(message.commandQueue) : undefined);
    ...
    message.confirmedEventQueue !== undefined && (obj.confirmedEventQueue = message.confirmedEventQueue ? QueueState.toJSON(message.confirmedEventQueue) : undefined);
    return obj;
  },
