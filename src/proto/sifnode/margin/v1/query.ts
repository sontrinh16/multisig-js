...
export const StatusResponse = {
  ...
  fromJSON(object: any): StatusResponse {
    return {
      openMtpCount: isSet(object.openMtpCount) ? Long.fromString(object.openMtpCount) : Long.UZERO,
      lifetimeMtpCount: isSet(object.lifetimeMtpCount) ? Long.fromString(object.lifetimeMtpCount) : Long.UZERO
    };
  },
  ...
  toJSON(message: StatusResponse): unknown {
    ...
    message.lifetimeMtpCount !== undefined && (obj.lifetimeMtpCount = (message.lifetimeMtpCount || Long.UZERO).toString());
    return obj;
  },
...
export const GetSQParamsResponse = {
  ...
  fromJSON(object: any): GetSQParamsResponse {
    return {
      beginBlock: isSet(object.beginBlock) ? Long.fromString(object.beginBlock) : Long.ZERO
    };
  },
