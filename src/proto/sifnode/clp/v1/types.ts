...
export const LiquidityUnlock = {
  ...
  fromJSON(object: any): LiquidityUnlock {
    return {
      requestHeight: isSet(object.requestHeight) ? Long.fromString(object.requestHeight) : Long.ZERO,
...
export const PmtpEpoch = {
  ...
  fromJSON(object: any): PmtpEpoch {
    return {
      epochCounter: isSet(object.epochCounter) ? Long.fromString(object.epochCounter) : Long.ZERO,
      blockCounter: isSet(object.blockCounter) ? Long.fromString(object.blockCounter) : Long.ZERO
    };
  },
