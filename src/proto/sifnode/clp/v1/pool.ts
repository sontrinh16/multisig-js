...
export const Pool = {
  ...
  fromJSON(object: any): Pool {
    return {
      ...
      lastHeightInterestRateComputed: isSet(object.lastHeightInterestRateComputed) ? Long.fromString(object.lastHeightInterestRateComputed) : Long.ZERO
    };
  },
  ...
  toJSON(message: Pool): unknown {
    ...
    message.rewardPeriodNativeDistributed !== undefined && (obj.rewardPeriodNativeDistributed = message.rewardPeriodNativeDistributed);
    ...
    message.lastHeightInterestRateComputed !== undefined && (obj.lastHeightInterestRateComputed = (message.lastHeightInterestRateComputed || Long.ZERO).toString());
    return obj;
  },
