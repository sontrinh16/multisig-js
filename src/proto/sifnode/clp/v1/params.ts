...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      minCreatePoolThreshold: isSet(object.minCreatePoolThreshold) ? Long.fromString(object.minCreatePoolThreshold) : Long.UZERO,
  ...
  toJSON(message: Params): unknown {
    const obj: any = {};
    message.minCreatePoolThreshold !== undefined && (obj.minCreatePoolThreshold = (message.minCreatePoolThreshold || Long.UZERO).toString());
...
export const RewardPeriod = {
  ...
  fromJSON(object: any): RewardPeriod {
    return {
      ...
      rewardPeriodStartBlock: isSet(object.rewardPeriodStartBlock) ? Long.fromString(object.rewardPeriodStartBlock) : Long.UZERO,
      rewardPeriodEndBlock: isSet(object.rewardPeriodEndBlock) ? Long.fromString(object.rewardPeriodEndBlock) : Long.UZERO,
      ...
      rewardPeriodMod: isSet(object.rewardPeriodMod) ? Long.fromString(object.rewardPeriodMod) : Long.UZERO
    };
  },
  ...
  toJSON(message: RewardPeriod): unknown {
    ...
    message.rewardPeriodStartBlock !== undefined && (obj.rewardPeriodStartBlock = (message.rewardPeriodStartBlock || Long.UZERO).toString());
    message.rewardPeriodEndBlock !== undefined && (obj.rewardPeriodEndBlock = (message.rewardPeriodEndBlock || Long.UZERO).toString());
    ...
    if (message.rewardPeriodPoolMultipliers) {
      obj.rewardPeriodPoolMultipliers = message.rewardPeriodPoolMultipliers.map(e => e ? PoolMultiplier.toJSON(e) : undefined);
    } else {
      obj.rewardPeriodPoolMultipliers = [];
    }

    message.rewardPeriodDefaultMultiplier !== undefined && (obj.rewardPeriodDefaultMultiplier = message.rewardPeriodDefaultMultiplier);
...
export const ProviderDistributionPeriod = {
  ...
  fromJSON(object: any): ProviderDistributionPeriod {
    return {
      ...
      distributionPeriodStartBlock: isSet(object.distributionPeriodStartBlock) ? Long.fromString(object.distributionPeriodStartBlock) : Long.UZERO,
      distributionPeriodEndBlock: isSet(object.distributionPeriodEndBlock) ? Long.fromString(object.distributionPeriodEndBlock) : Long.UZERO,
      distributionPeriodMod: isSet(object.distributionPeriodMod) ? Long.fromString(object.distributionPeriodMod) : Long.UZERO
    };
  },

  toJSON(message: ProviderDistributionPeriod): unknown {
    const obj: any = {};
    message.distributionPeriodBlockRate !== undefined && (obj.distributionPeriodBlockRate = message.distributionPeriodBlockRate);
    message.distributionPeriodStartBlock !== undefined && (obj.distributionPeriodStartBlock = (message.distributionPeriodStartBlock || Long.UZERO).toString());
    message.distributionPeriodEndBlock !== undefined && (obj.distributionPeriodEndBlock = (message.distributionPeriodEndBlock || Long.UZERO).toString());
    message.distributionPeriodMod !== undefined && (obj.distributionPeriodMod = (message.distributionPeriodMod || Long.UZERO).toString());
    return obj;
  },
