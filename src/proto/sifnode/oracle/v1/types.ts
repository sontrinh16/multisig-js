...
export const DBProphecy = {
  ...
  toJSON(message: DBProphecy): unknown {
    ...
    message.claimValidators !== undefined && (obj.claimValidators = base64FromBytes(message.claimValidators !== undefined ? message.claimValidators : new Uint8Array()));
    message.validatorClaims !== undefined && (obj.validatorClaims = base64FromBytes(message.validatorClaims !== undefined ? message.validatorClaims : new Uint8Array()));
    return obj;
  },
