...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/sifnode.ethbridge.v1.MsgLock", MsgLock], ["/sifnode.ethbridge.v1.MsgBurn", MsgBurn], ["/sifnode.ethbridge.v1.MsgCreateEthBridgeClaim", MsgCreateEthBridgeClaim], ["/sifnode.ethbridge.v1.MsgUpdateWhiteListValidator", MsgUpdateWhiteListValidator], ["/sifnode.ethbridge.v1.MsgUpdateCethReceiverAccount", MsgUpdateCethReceiverAccount], ["/sifnode.ethbridge.v1.MsgRescueCeth", MsgRescueCeth], ["/sifnode.ethbridge.v1.MsgSetBlacklist", MsgSetBlacklist]];
...
export const MessageComposer = {
  ...
  toJSON: {
    ...
    createEthBridgeClaim(value: MsgCreateEthBridgeClaim) {
      return {
        typeUrl: "/sifnode.ethbridge.v1.MsgCreateEthBridgeClaim",
        value: MsgCreateEthBridgeClaim.toJSON(value)
      };
    },
    ...
    updateWhiteListValidator(value: MsgUpdateWhiteListValidator) {
      return {
        typeUrl: "/sifnode.ethbridge.v1.MsgUpdateWhiteListValidator",
        value: MsgUpdateWhiteListValidator.toJSON(value)
      };
    },
    ...
    updateCethReceiverAccount(value: MsgUpdateCethReceiverAccount) {
      return {
        typeUrl: "/sifnode.ethbridge.v1.MsgUpdateCethReceiverAccount",
        value: MsgUpdateCethReceiverAccount.toJSON(value)
      };
    },
    ...
    rescueCeth(value: MsgRescueCeth) {
      return {
        typeUrl: "/sifnode.ethbridge.v1.MsgRescueCeth",
        value: MsgRescueCeth.toJSON(value)
      };
    },
    ...
    setBlacklist(value: MsgSetBlacklist) {
      return {
        typeUrl: "/sifnode.ethbridge.v1.MsgSetBlacklist",
        value: MsgSetBlacklist.toJSON(value)
      };
    }
