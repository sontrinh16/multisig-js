...
export const GenesisState = {
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.distributions !== undefined && (obj.distributions = message.distributions ? Distributions.toJSON(message.distributions) : undefined);
...
export const DistributionRecord = {
  ...
  fromJSON(object: any): DistributionRecord {
    return {
      ...
      distributionStartHeight: isSet(object.distributionStartHeight) ? Long.fromString(object.distributionStartHeight) : Long.ZERO,
      distributionCompletedHeight: isSet(object.distributionCompletedHeight) ? Long.fromString(object.distributionCompletedHeight) : Long.ZERO,
  ...
  toJSON(message: DistributionRecord): unknown {
    const obj: any = {};
    message.distributionStatus !== undefined && (obj.distributionStatus = distributionStatusToJSON(message.distributionStatus));
    ...
    message.distributionStartHeight !== undefined && (obj.distributionStartHeight = (message.distributionStartHeight || Long.ZERO).toString());
    message.distributionCompletedHeight !== undefined && (obj.distributionCompletedHeight = (message.distributionCompletedHeight || Long.ZERO).toString());
...
export const MintController = {
  ...
  toJSON(message: MintController): unknown {
    const obj: any = {};
    message.totalCounter !== undefined && (obj.totalCounter = message.totalCounter ? Coin.toJSON(message.totalCounter) : undefined);
    return obj;
  },
